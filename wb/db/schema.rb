...
ActiveRecord::Schema.define(version: 2021_01_03_193713) do
  ...
  create_table "facilities", force: :cascade do |t|
    ...
    t.index ["admin_user_id"], name: "index_facilities_on_admin_user_id"
  end
  ...
  create_table "work_orders", force: :cascade do |t|
    ...
    t.string "password_digest"
    t.bigint "admin_user_id"
    t.index ["admin_user_id"], name: "index_work_orders_on_admin_user_id"
  ...
  add_foreign_key "facilities", "admin_users"
  add_foreign_key "floors", "facilities"
  add_foreign_key "rooms", "facilities"
  add_foreign_key "rooms", "floors"
  add_foreign_key "work_orders", "admin_users"
